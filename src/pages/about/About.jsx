  ...
  return (
    <>
      ...
      <div className={styles.subtitulo}>
        <img src={fluxoImg} />
        <p>Aprenda as soft e hard skills ideais para te ajudar migrar de carreira e se tornar uma dev front-end jr. As aulas mostram um passo a passo coerente, sem enrolação e com muita mão no código.</p>
      </div>
      <div className={styles.containerSobre}>
        <div className={styles.tituloSobre}>
          Vem conhecer um pouquinho sobre quem é a criadora da Mentoria Quero Ser Dev.
          Saiba como Simara Conceição se tornou desenvolvedora de software após os 30 anos, vindo de uma área completamente diferente.
        </div>
