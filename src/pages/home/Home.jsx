  ...
  return (
    <>
      ...
      <div className={styles.subtitulo}>
        <p>Quer fazer migração de carreira e conquistar sua vaga como pessoa desenvolvedora? Aprenda como migrar de carreira e se tornar uma dev front-end jr., com um passo a passo coerente, sem enrolação e com muita mão no código.</p>
      </div>
        ...
        <div className={styles.cards}>
          <div className={styles.card}>
            ...
            <div className={styles.textos}>
              ...
              <p className={styles.texto}>Aprenda habilidades técnicas e comportamentais de uma dev iniciante. Segue um roadmap para que você possa se tornar uma pessoa desenvolvedora front-end iniciante. Entenda como focar no que realmente importa estudar para sair do zero, sem enrolação.</p>
            </div>
          </div>
          <div className={styles.card}>
